...
class OffDay extends StatefulWidget {
  const OffDay({super.key});

  @override
  State<OffDay> createState() => _OffDayState();
}

class _OffDayState extends State<OffDay> {
...
// จบการดึง GPS
  ...
  Future<void> LaYoot() async {
    ...
    myReq['Comment_post'] = "ลา";
    myReq['Chkin_type'] = 'LA_';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        ...
        children: [
          Image.asset('assets/images/outoffice.jpg'),
          SizedBox(
            height: 60,
          ),
          Padding(
